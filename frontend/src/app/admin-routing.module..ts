...
const routes: Routes = [
  ...
  {path:'admin/login/inquiry' , component:AdmininquiryComponent,  canActivate: [AdminAuthGuard]},
  {path:'admin/login/category', component: AdmincategoryComponent,  canActivate: [AdminAuthGuard]}
];
@NgModule({
  imports:[
